        ...
        <div className="text-center space-y-4">
          ...
          <div className="mt-6 inline-flex items-center rounded-full border bg-background p-1 text-sm shadow-sm">
            <button
              ...
              className={`px-4 py-1.5 rounded-full transition-all duration-200 ${billing === "monthly" ? "bg-foreground text-background shadow-sm" : "hover:bg-muted"
                }`}
            >
              Hàng tháng
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-full transition-all duration-200 ${billing === "yearly" ? "bg-foreground text-background shadow-sm" : "hover:bg-muted"
                }`}
            >
              Hàng năm
            </button>
          ...
          {plans.map((plan) => (
            <div key={plan.key} className={`rounded-3xl border bg-background transition-all duration-300 hover:shadow-lg ${plan.popular ? 'ring-2 ring-foreground/20' : 'hover:border-foreground/20'}`}>
              ...
              <div className="px-6 pt-6">
                ...
                <button
                  className={`mt-6 w-full rounded-xl px-4 py-3 text-sm font-medium border transition-all duration-200 ${plan.popular
